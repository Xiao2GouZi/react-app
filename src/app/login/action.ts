 ...
 *  登录, 注册 开始加载
 * */
export const loginLoading = createAction(ActionTypes.LOGIN_LOGIN_LOADING, (n: boolean) => n);

export const loginStatus = createAction(ActionTypes.LOGIN_LOGIN_SUCCESS, (n: boolean) => n);
 ...
 *  切换登录方式
 * */
export const checkLoginType = createAction(ActionTypes.LOGIN_CHECK_LOGIN_TYPE, (n: TSType.ELoginType) => n);
 ...
 *  获取国家数据传成功
 * */
export const actionSupportCountries = createAction(ActionTypes.LOGIN_DOWN_LOAD_SUPPORT_COUNTRIES, (n: Array<TSType.ISupportCountriesItem>) => n);
